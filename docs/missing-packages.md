...
**Host total**: 2829 | **🔧 custom channel**: 124 | **❌ needs packaging**: 238 | **✅ library deps (auto-pulled)**: 835 | *(835 libraries + ~22 base-system already covered by Guix)*
...
| `accountsservice` | ❌ missing | needs Guix packaging |
| `acpica` | ❌ missing | needs Guix packaging |
| `amd-ucode` | ❌ missing | needs Guix packaging |
| `amneziawg-dkms` | ❌ missing | needs Guix packaging |
| `apache` | ❌ missing | needs Guix packaging |
| `apparmor` | ❌ missing | needs Guix packaging |
| `archlinux-keyring` | ❌ missing | needs Guix packaging |
| `bandwhich` | ❌ missing | needs Guix packaging |
| `bc` | ❌ missing | needs Guix packaging |
| `bcc` | ❌ missing | needs Guix packaging |
| `bind` | ❌ missing | needs Guix packaging |
| `bpftrace` | ❌ missing | needs Guix packaging |
| `breeze-cursors` | ❌ missing | needs Guix packaging |
| `cabal-install` | ❌ missing | needs Guix packaging |
| `cmake-format` | ❌ missing | needs Guix packaging |
| `colord` | ❌ missing | needs Guix packaging |
| `containerd` | ❌ missing | needs Guix packaging |
| `cosmic-comp` | ❌ missing | needs Guix packaging |
| `cosmic-greeter` | ❌ missing | needs Guix packaging |
| `cython` | ❌ missing | needs Guix packaging |
| `debuginfod` | ❌ missing | needs Guix packaging |
| `deno` | ❌ missing | needs Guix packaging |
| `dhcpcd` | ❌ missing | needs Guix packaging |
| `dos2unix` | ❌ missing | needs Guix packaging |
| `doxygen` | ❌ missing | needs Guix packaging |
| `dtc` | ❌ missing | needs Guix packaging |
| `dust` | ❌ missing | needs Guix packaging |
| `fakeroot` | ❌ missing | needs Guix packaging |
| `file` | ❌ missing | needs Guix packaging |
| `filesystem` | ❌ missing | needs Guix packaging |
| `findutils` | ❌ missing | needs Guix packaging |
| `flashrom` | ❌ missing | needs Guix packaging |
| `gawk` | ❌ missing | needs Guix packaging |
| `gdm` | ❌ missing | needs Guix packaging |
| `geoclue` | ❌ missing | needs Guix packaging |
| `gettext` | ❌ missing | needs Guix packaging |
| `ghc` | ❌ missing | needs Guix packaging |
| `git-extras` | ❌ missing | needs Guix packaging |
| `gitlogue` | ❌ missing | needs Guix packaging |
| `gnome-characters` | ❌ missing | needs Guix packaging |
| `gnome-clocks` | ❌ missing | needs Guix packaging |
| `gnome-color-manager` | ❌ missing | needs Guix packaging |
| `gnome-console` | ❌ missing | needs Guix packaging |
| `gnome-contacts` | ❌ missing | needs Guix packaging |
| `gnome-control-center` | ❌ missing | needs Guix packaging |
| `gnome-disk-utility` | ❌ missing | needs Guix packaging |
| `gnome-online-accounts` | ❌ missing | needs Guix packaging |
| `gnome-remote-desktop` | ❌ missing | needs Guix packaging |
| `gnome-settings-daemon` | ❌ missing | needs Guix packaging |
| `gnome-shell` | ❌ missing | needs Guix packaging |
| `gnome-tour` | ❌ missing | needs Guix packaging |
| `gnome-user-share` | ❌ missing | needs Guix packaging |
| `go-yq` | ❌ missing | needs Guix packaging |
| `goaccess` | ❌ missing | needs Guix packaging |
| `gperf` | ❌ missing | needs Guix packaging |
| `grafana` | ❌ missing | needs Guix packaging |
| `grep` | ❌ missing | needs Guix packaging |
| `groff` | ❌ missing | needs Guix packaging |
| `help2man` | ❌ missing | needs Guix packaging |
| `hwloc` | ❌ missing | needs Guix packaging |
| `ioping` | ❌ missing | needs Guix packaging |
| `iproute2` | ❌ missing | needs Guix packaging |
| `iptables` | ❌ missing | needs Guix packaging |
| `iputils` | ❌ missing | needs Guix packaging |
| `iw` | ❌ missing | needs Guix packaging |
| `jdk8-openjdk` | ❌ missing | needs Guix packaging |
| `jre8-openjdk` | ❌ missing | needs Guix packaging |
| `licenses` | ❌ missing | needs Guix packaging |
| `linux-cachyos` | ❌ missing | needs Guix packaging |
| `linux-cachyos-eevdf` | ❌ missing | needs Guix packaging |
| `linux-cachyos-hardened` | ❌ missing | needs Guix packaging |
| `linux-cachyos-lts` | ❌ missing | needs Guix packaging |
| `linux-firmware` | ❌ missing | needs Guix packaging |
| `linux-firmware-amdgpu` | ❌ missing | needs Guix packaging |
| `linux-firmware-atheros` | ❌ missing | needs Guix packaging |
| `linux-firmware-broadcom` | ❌ missing | needs Guix packaging |
| `linux-firmware-cirrus` | ❌ missing | needs Guix packaging |
| `linux-firmware-intel` | ❌ missing | needs Guix packaging |
| `linux-firmware-mediatek` | ❌ missing | needs Guix packaging |
| `linux-firmware-nvidia` | ❌ missing | needs Guix packaging |
| `linux-firmware-other` | ❌ missing | needs Guix packaging |
| `linux-firmware-radeon` | ❌ missing | needs Guix packaging |
| `linux-firmware-realtek` | ❌ missing | needs Guix packaging |
| `linux-firmware-whence` | ❌ missing | needs Guix packaging |
| `lld` | ❌ missing | needs Guix packaging |
| `llvm` | ❌ missing | needs Guix packaging |
| `llvm21` | ❌ missing | needs Guix packaging |
| `lsscsi` | ❌ missing | needs Guix packaging |
| `luajit` | ❌ missing | needs Guix packaging |
| `m4` | ❌ missing | needs Guix packaging |
| `man-pages` | ❌ missing | needs Guix packaging |
| `mkinitcpio` | ❌ missing | needs Guix packaging |
| `nasm` | ❌ missing | needs Guix packaging |
| `ncurses` | ❌ missing | needs Guix packaging |
| `net-snmp` | ❌ missing | needs Guix packaging |
| `netpbm` | ❌ missing | needs Guix packaging |
...
| `pacman` | ❌ missing | needs Guix packaging |
| `pacman-mirrorlist` | ❌ missing | needs Guix packaging |
| `pahole` | ❌ missing | needs Guix packaging |
| `pambase` | ❌ missing | needs Guix packaging |
| `pandoc-cli` | ❌ missing | needs Guix packaging |
| `patch` | ❌ missing | needs Guix packaging |
| `patool` | ❌ missing | needs Guix packaging |
| `pcsclite` | ❌ missing | needs Guix packaging |
| `perf` | ❌ missing | needs Guix packaging |
...
| `ripgrep-all` | ❌ missing | needs Guix packaging |
| `rpcbind` | ❌ missing | needs Guix packaging |
| `rubygems` | ❌ missing | needs Guix packaging |
| `rust-bindgen` | ❌ missing | needs Guix packaging |
| `rust-src` | ❌ missing | needs Guix packaging |
| `sassc` | ❌ missing | needs Guix packaging |
| `sbctl` | ❌ missing | needs Guix packaging |
| `scdoc` | ❌ missing | needs Guix packaging |
| `schedtool` | ❌ missing | needs Guix packaging |
| `scons` | ❌ missing | needs Guix packaging |
| `sed` | ❌ missing | needs Guix packaging |
| `sleuthkit` | ❌ missing | needs Guix packaging |
| `spice` | ❌ missing | needs Guix packaging |
| `stack` | ❌ missing | needs Guix packaging |
| `tar` | ❌ missing | needs Guix packaging |
| `texinfo` | ❌ missing | needs Guix packaging |
| `texlive-basic` | ❌ missing | needs Guix packaging |
| `texlive-bin` | ❌ missing | needs Guix packaging |
| `texlive-latex` | ❌ missing | needs Guix packaging |
| `tree-sitter-cli` | ❌ missing | needs Guix packaging |
| `vim-runtime` | ❌ missing | needs Guix packaging |
| `w3m` | ❌ missing | needs Guix packaging |
| `wireshark-cli` | ❌ missing | needs Guix packaging |
| `wsdd` | ❌ missing | needs Guix packaging |
| `xz` | ❌ missing | needs Guix packaging |
