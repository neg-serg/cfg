...
### LM-04: Validation loop ✅

**Practice**: After any state change generated by an AI tool, run `just validate` to confirm the change doesn't break any state. This is encoded in CLAUDE.md as a validation requirement.
...
**This project**: CLAUDE.md "Validation Requirements" section mandates running `just` (default: `system_description`) before handing results back to the user.
...
**This project**: Constitution (version 1.1.0) defines 8 principles: Idempotency, Network Resilience, Secrets Isolation, Macro-First, Minimal Change, Convention Adherence, Verification Gate, Release Gate.
...
| 2024-10 | Salt Project AWS infrastructure removed | High — public automation stopped, community trust damaged |
