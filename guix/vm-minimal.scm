...
(use-package-modules admin audio base bootloaders certs compression
 ...
 version-control vim wget xdisorg xorg wm terminals rust-apps backup vpn mpd containers text-editors kde-utils kde-systemtools kde-internet sync web telegram)
...
%wheel ALL=NOPASSWD: ALL\n"))
 ...
 "qrencode" "stress-ng"
 "libnotify" "xdg-utils"
 "i3-wm" "i3status" "ansible" "ardour" "audacity" "awscli" "baobab" "bash" "bottom" "calibre" "cliphist" "clipman" "corectrl" "darktable" "delta" "digikam" "distrobox" "doctl" "easyeffects" "evince" "eza" "fastfetch" "filelight" "filezilla" "fish" "flameshot" "gamemode" "glances" "gparted" "handbrake" "helm" "kdenlive" "keepassxc" "kodi" "lsd" "mariadb" "meld" "neofetch" "nginx" "openshot" "partitionmanager" "pavucontrol" "peek" "postgresql" "qbittorrent" "redis" "scribus" "smplayer" "sqlite" "starship" "strawberry" "swayidle" "swaylock" "vlc" "watchexec" "wireshark" "ark" "cage" "difftastic" "dive" "fclones" "helix" "hypridle" "hyprland" "hyprlock" "hyprpicker" "jujutsu" "konsole" "ncmpcpp" "nicotine+" "openvpn" "ouch" "restic" "wayvnc" "wev" "wezterm" "xdg-desktop-portal-hyprland" "xdg-user-dirs" "ydotool" "yq" "ardour" "audacious" "audacity" "baobab" "bemenu" "blanket" "brightnessctl" "celluloid" "clementine" "darktable" "deluge" "difftastic" "feh" "filelight" "flameshot" "foot" "fuzzel" "gammastep" "gimp" "gnome-authenticator" "gparted" "grimshot" "haruna" "helix" "imv" "inkscape" "kdeconnect" "keepassxc" "libreoffice" "light" "lmms" "mangohud" "mupdf" "musescore" "nextcloud-client" "nicotine+" "nsxiv" "openvpn" "pamixer" "peek" "playerctl" "pulsemixer" "qbittorrent" "secrets" "smplayer" "strawberry" "swaybg" "swayidle" "swaylock" "sxiv" "tofi" "wdisplays" "wf-recorder" "wine" "wl-mirror" "wlsunset" "zathura-pdf-mupdf" "atuin" "bpftrace" "buildah" "certbot" "cloc" "curlie" "delve" "docker-compose" "exa" "fontforge" "fzy" "gdu" "git-delta" "gitui" "grc" "gron" "gthumb" "helvum" "iftop" "iperf" "jless" "just" "krita" "lf" "loupe" "lynis" "micro" "miller" "nethogs" "nload" "okular" "onefetch" "pastel" "pgcli" "pitivi" "polari" "procs" "proxychains-ng" "ranger" "ripgrep-all" "ruff" "s3cmd" "scc" "sd" "shfmt" "shotcut" "skim" "tessen" "tilix" "tldr" "tokei" "ugrep" "upx" "vale" "xournalpp" "zk" "zsh-syntax-highlighting" "aerc" "age-plugin-yubikey" "asciidoc" "aspell" "aspell-en" "aspell-ru" "autoconf" "automake" "avahi" "bash-completion" "bc" "bind" "binutils" "bison" "bochs" "boost" "bridge-utils" "brotli" "cmake-format" "cmatrix" "cowsay" "cpuid" "cpulimit" "cronie" "yubikey-manager"))
 %base-packages))
 (services
 (cons*
