...
(use-package-modules admin audio base bootloaders certs compression
 ...
 version-control vim wget xdisorg xorg wm terminals rust-apps backup vpn mpd containers text-editors kde-utils kde-systemtools kde-internet sync)
