...
def generate_singbox_config(base_config_path: Path, domains: list[str], 
                           output_path: Path, max_domains: int = 1000) -> None:
...
def main():
    ...
    parser.add_argument("--base-config", default="~/.config/sing-box-tun/config-no-auto-route.json",
    ...
    parser.add_argument("--output", default="~/.config/sing-box-tun/config-with-rkn.json",
    ...
    print(f"  systemctl --user restart sing-box-tun")
