...
{#- @state
   id: group.ai
   purpose: "AI group: llama_embed, ollama, opencode, telethon_bridge, video_ai, image_gen."
   includes: [code_rag, image_generation, llama_embed, managed_bots, ollama, pacman_db_warmup, t5_summarization, telethon_bridge, video_ai]
   feature_gate: [image_gen, llama_embed, managed_bots, ollama, t5_summarization, telethon_bridge, video_ai]
#}
